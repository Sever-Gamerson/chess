...
public class BoardRenderer {
    ...
    private static final String BORDER_BG = "\u001B[100m";     // dark gray border
    private static final String BORDER_TEXT = "\u001B[97m";    // white border text
    ...
    private static void printSquare(String piece, boolean lightSquare) {
        ...
        System.out.print(bg + " " + piece + " " + RESET);
    }
}
